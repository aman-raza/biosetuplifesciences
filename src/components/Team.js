      ...
      <div className="team-container">
        {orgs.map((m, index) => (
          <div
            key={index}
            className="flip-card"
            onMouseOver={() => setOrghover(index)}
            onMouseLeave={() => setOrghover(null)}
          >
            <div
              className={`flip-card-inner ${
                orghover === index ? "flipped" : ""
              }`}
            >
              {/* Front Face */}
              ...
              <div className="flip-card-back">
                ...
                <div className="team-member-details">
                  ...
                  <div className="team-member-email">
                    ...
                    <div>
                      <p>
                        <a href={m.emaillink} target="_blank" rel="noreferrer">
                          {m.email}
                        </a>
                      </p>
                    </div>
      ...
      <div className="team-container">
        {Volunteer_interns.map((m, index) => (
          <div
            key={index}
            className="flip-card"
            onMouseOver={() => setVolunterhover(index)}
            onMouseLeave={() => setVolunterhover(null)}
          >
            <div
              className={`flip-card-inner ${
                volunterhover === index ? "flipped" : ""
              }`}
            >
              {/* Front Face */}
              <div className="flip-card-front">
                <span
                  className={`${
                    m.post === "Social Media Specialist" ||
                    m.post === "Event Coordinator Executive"
                      ? "team-member-img-promoted"
                      : "team-member-img"
                  }`}
                >
                  <img
      ...
      <div className="team-container">
        {SAM.map((m, index) => (
          <div
            key={index}
            className="flip-card"
            onMouseOver={() => setMemberhover(index)}
            onMouseLeave={() => setMemberhover(null)}
          >
            <div
              className={`flip-card-inner ${
                memberhover === index ? "flipped" : ""
              }`}
            >
              {/* Front Face */}
              <div className="flip-card-front">
  ...
  return (
    <div>
      ...
      <div className="team-member-container">
        <div
          onClick={() => setToggle(0)}
          className={`team-member-containter-button ${
            toggle === 0 ? "team-member-containter-button-active" : ""
          }`}
        >
          <h3>Organisers</h3>
        </div>
        <div
          onClick={() => setToggle(1)}
          className={`team-member-containter-button ${
            toggle === 1 ? "team-member-containter-button-active" : ""
          }`}
        >
          <h3>Volunteers</h3>
        </div>
        <div
          onClick={() => setToggle(2)}
          className={`team-member-containter-button ${
            toggle === 2 ? "team-member-containter-button-active" : ""
          }`}
        >
