          ...
          <div className="about-box">
            <div className="about-card-inner">
              ...
              <div className="about-card-back genz-back-card">
                ...
                <p className="genz-description">Gen Z is the generation born between 1997 and 2012, known for being digital natives and socially conscious."We are the future, and we are ready to make a difference."</p>
                <button class="genz-visit-button" onClick={handleClick}>Visit</button>
              </div>
            </div>
          </div>
        </div>
